...
Construído por um laptop modelo antigo (Lgx130), usando o Samba Server (SMB3), ele pode funcionar como o Google Drive para vários arquivos da minha família e também fornecer jogos para o console PS2 pela OPL nas Configurações de Redes.
...
Builded by an old model laptop (Lgx130), using  Samba Server (SMB3), it's may work like Google Drive for several files from my family and also provide games to PS2 console by OPL on Networks Settings.
